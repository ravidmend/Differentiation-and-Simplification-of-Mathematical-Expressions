...
public class Mult extends BinaryExpression implements Expression {
    ...
    public Expression assign(String var, Expression expression) {
        Expression e = new Mult(this.getEx1(), this.getEx2());
        Expression e1;
        Expression e2;
    ...
    public Expression differentiate(String var) {
        ...
        return (new Plus(new Mult(dEx1, ex2), new Mult(ex1, dEx2)));
    }
    /**
    ...
    public Expression simplify() {
        ...
        if (ex1.simplify().toString().equals("0.0") || (ex2.simplify().toString().equals("0.0"))) {
            return (new Num(0));
        } else if (ex1.simplify().toString().equals("1.0")) {
            return (ex2.simplify());
        } else if (ex2.simplify().toString().equals("1.0")) {
            return (ex1.simplify());
        } else {
            return (new Mult(ex1.simplify(), ex2.simplify()));
        }
    }
}
